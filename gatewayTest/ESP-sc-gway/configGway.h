...
#define _DESCRIPTION "Project DEIMOS - ESP Gateway"			// Name of the gateway
#define _EMAIL "jssia@uwaterloo.ca"							// Owner
#define _PLATFORM "ESP8266"
#define _LAT 43.46778
#define _LON 80.56196
#define _ALT 345											// Altitude
